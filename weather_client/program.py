...
def main():
    ...
    code = input('What zipcode do you want the weather for? For instance (97201)')

    html = get_html_from_web(code)
    report = get_weather_from_html(html)

    print('The temperature in {} is {} {} and it is {}'.format(report.loc, report.temp, report.scale, report.cond))
